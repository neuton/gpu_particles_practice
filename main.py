...
class Application(OgreApplication):
    ...
    def _createScene(self):
        ...
        #  V
        #
        # Here's the main scene construction:
        # ------------------------------------------------------------------------------------------------
        # device -- may be "cpu" or "gpu"
        # scene_setting -- may be "rotating box" or "two boxes"
        ...
        #
        self.scene = SimulationScene(sm, device="gpu", scene_setting="rotating box", particles_count=2000)  # <---
        #
        # ------------------------------------------------------------------------------------------------
        #  .
        # / \
